"""Model factory for backbone selection and compilation."""
...
def build_model(backbone: str,
    ...
    """Construct a classifier with a frozen/unfrozen backbone."""
    ...
    return tf.keras.Model(inputs, outputs, name=f"{backbone}_transfer")
